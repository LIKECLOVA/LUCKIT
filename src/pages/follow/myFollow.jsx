...
export const MyFollow = () => {
  ...
  const followerURL = `https://api.mandarin.weniv.co.kr/profile/${accountname}/follower?limit=1000`;
  const followingURL = `https://api.mandarin.weniv.co.kr/profile/${accountname}/following?limit=1000`;
